...
Once registered with [QOR Admin](http://github.com/itech-eng/admin), [Worker](https://github.com/itech-eng/worker) will provide a `Workers` section in the navigation tree, containing pages for listing and managing the following aspects of Workers:
...
[![GoDoc](https://godoc.org/github.com/itech-eng/worker?status.svg)](https://godoc.org/github.com/itech-eng/worker)

## Usage

```go
import "github.com/itech-eng/worker"
